---
title: "Bayesing-based PK modelling of clonidine with informative priors"
...
The aim of this study is to illustrate applicability of Bayesian approach with informative priors to analyze small PK data.
...
The head of the analyzed data set:
...
First a simple graphical presentation of the data. Red plots denote outliers (unknown origin).
